<div class="col-sm-3 col-xs-6">
    <div class="product-item">
        <a target="_blank" class="pro-img" href="{{ $product->getUrl() }}" title="{{ $product->getName() }}">
            ...
            <img class="img-responsive" src="{{ $product->getImage() }}" alt="{{ $product->getName() }}">
        </a>
        <div class="product-metadata clearfix">
            ...
            <div class="product-price-item clearfix">
                ...
                <div class="count-store text-center mg-bt-10">
                    {{ $product->getTotalShop() }} cửa hàng bán
                </div>
                <a target="_blank" href="{{ $product->getUrl() }}" class="btn-buttom btn btn-md btn-readmore" title="Xem chi tiết">So sánh giá</a>
            </div>
        </div>
    </div>
</div>