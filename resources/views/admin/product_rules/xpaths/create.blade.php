    ...
    <div class="panel-body">
        <form class="form-horizontal bucket-form" method="post" action enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="site_id" class="form-control input-sm select2">
                        ...
                        @foreach($sites as $st)
                            <option value="{{ $st->getId() }}" {{ Request::old('site_id') == $st->getId() ? 'selected="selected"' : '' }}>{{ $st->getName() }}</option>
                        @endforeach
                    </select>
                    {!! alertError('site_id') !!}
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control input-sm" value="{{ Request::old('link_item') }}" name="link_item" placeholder="Link">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control input-sm" value="{{ Request::old('name') }}" name="name" placeholder="Tên">
                    {!! alertError('name') !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control input-sm" value="{{ Request::old('price') }}" name="price" placeholder="Giá">
                    {!! alertError('price') !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control input-sm" value="{{ Request::old('image') }}" name="image">
                    {!! alertError('image') !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control input-sm" value="{{ Request::old('images') }}" name="images">
                    {!! alertError('images') !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control input-sm" value="{{ Request::old('spec') }}" name="spec">
                    {!! alertError('spec') !!}
                </div>
            </div>
