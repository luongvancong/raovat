                ...
                <div class="col-md-9">
                    <div class="mua-ban">
                        <div class="mua-ban-right">
                            ...
                            <a href="{!! url('danh-sach-tin/'.$city->getId()) !!}" class="in-dam" title="{!! $city->getName() !!}"> @if(isset($city)){!! $city->getName() !!}@endif <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
