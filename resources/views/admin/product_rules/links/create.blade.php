            ...
            <div class="form-group">
                <div class="col-sm-10 col-sm-offset-1" id="add-link">
                        ...
                        <fieldset class="link-field origin-link">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        @foreach($sites as $sit)
                                            <option value="{{ $sit->getId() }}" {{ $sit->getId() == $site->getId() ? 'selected="selected"' : '' }}>{{ $sit->getName() }}</option>
                                        @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        @foreach($brands as $brand)
                                            <option value="{{ $brand->getId() }}" {{ $brand->getId() == Request::old('brand_id') ? 'selected="selected"' : '' }}>{{ $brand->getName() }}</option>
                                        @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group {{ hasValidator('type_device') }}">
                                <label for="input" class="col-sm-2 control-label">Device:</label>
                                <div class="col-sm-10">
                                    @foreach($deviceOptions as $key => $value)
                                        <label class="radio-inline">
                                            <input type="radio" name="type_device" value="{{ $key }}" {{ Request::old('type_device') == $key ? 'checked' : '' }}> {{ $value }}
                                        </label>
                                    @endforeach
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        @foreach($xpaths as $xpath)
                                            <option value="{{ $xpath->getId() }}">{{ $xpath->getLink() }}</option>
                                        @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group {{ hasValidator('url') }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control input-sm" id="url" name="url" value="{{ Request::old('url') }}" placeholder="Link">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control input-sm" id="max_page" name="max_page" value="{{ Request::old('max_page', 1) }}" placeholder="1">
                                </div>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control input-sm" id="step_page" name="step_page" value="{{ Request::old('step_page', 1) }}" placeholder="1">
                                </div>
                            </div>
