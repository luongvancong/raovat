        ...
        <div class="row">
            <div class="main-content">
                <div class="col-md-6 main-left">
                    ...
                    <div class="arrow-box">
                        <i>Nhờ có Chợ Tốt mình đã nhận được nhìu hơn sự quan tậm của khách hàng . Chúc chợ tốt ngày càng phát triển</i>
                        <br>
                    ...
                    <div class="like-share">
                        <div class="fb-like" data-href="http://localhost:8000/" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></div>
                    </div>
                </div>
                <!-- map -->
                ...
                <div class="col-md-3 main-right">
                    ...
                    <div class="menu-right">
                        <ul>
                            ...
                            <li><a id="" href="{!! url('danh-sach-tin/'.$city->getId()) !!}" title="{!! $city->getName() !!}">{!! $city->getName() !!}</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
