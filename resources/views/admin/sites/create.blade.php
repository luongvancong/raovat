	...
	<div class="panel-body">
		<form class="form-horizontal bucket-form" method="post" action enctype="multipart/form-data">
			<div class="form-group {{ hasValidator('name') }}">
				<label for="email" class="col-sm-3 control-label">Tên miền <b class="text-danger">*</b></label>
				<div class="col-sm-6 text-center">
					<input type="text" class="form-control input-sm" value="{{ Request::old('name') }}" name="name">
					{!! alertError('name') !!}
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6 text-center">
					<input type="text" class="form-control input-sm" value="{{ Request::old('alias') }}" name="alias">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6 text-center">
					<input type="text" class="form-control input-sm" readonly="true" value="{{ Request::old('slug') }}" name="slug">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6 text-center">
					<select name="parent_id" class="form-control input-sm select2">
						...
						<option value="{{ $site->getId() }}" {{ old('parent_id') == $site->getId() ? 'selected' : '' }}>{{ $site->getName() }}</option>
						@endforeach
					</select>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6 text-center">
					<input type="text" class="form-control input-sm" value="{{ Request::old('address') }}" name="address">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6 text-center">
					<input type="text" class="form-control input-sm" value="{{ Request::old('phone') }}" name="phone">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6 text-center">
					<input type="text" class="form-control input-sm" value="{{ Request::old('fax') }}" name="fax">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6 text-center">
					<div class="input-group">
						<input type="text" class="form-control input-sm" value="{{ Request::old('latitude') }}" name="latitude">
			...
			<div class="form-group">
				...
				<div class="col-sm-6 text-center">
					<div class="input-group">
						<input type="text" class="form-control input-sm" value="{{ Request::old('longitude') }}" name="longitude">
						<span class="input-group-addon get-lat-long">Lấy tọa độ</span>
					</div>
				</div>
			</div>
